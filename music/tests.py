...
from .models import Artists, Albums, ArtistImage, Tracks, MediaTypes
...
class BaseTestCaseWithArtistsAlbumsTracks(APITestCase):
    def setUp(self) -> None:
        ...
        self.artist1 = Artists.objects.create(name="Artist 1", artistid=1)
        self.artist2 = Artists.objects.create(name="Artist 2", artistid=2)
        ArtistImage.objects.create(artist=self.artist1, image="fakeimage.jpg")
        self.album1 = Albums.objects.create(
            title="Album 1", artistid=self.artist1, albumid=1
        )
        self.album2 = Albums.objects.create(
            title="Album 2", artistid=self.artist2, albumid=2
        )
        ...
        self.assertEqual(
            dict(response.data),
            {
                ...
                "results": [
                    ...
                    {"albumid": 2, "tracks": [], "title": "Album 2", "artistid": 2},
                ],
            },
        )
    ...
    def test_list_artist_albums_authenticated(self):
        ...
        self.assertEqual(
            to_dict(response.data),
            {
                ...
                "next": None,
                "previous": None,
                "results": [{"albumid": 1, "title": "Album 1", "artistid": 1}],
            },
        )
